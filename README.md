...
Цей репозиторій містить декілька незалежних проєктів (тасків), які можна запускати в [🔗**sandbox-середовищі**](https://codesandbox.io/p/github/OleziO/SoftinixTasks/main?import=true) для тестування та перевірки рішень.
